...
### 3 - Configure your host machine to access the VM.
  ...
  1. [Edit your hosts file](http://docs.rackspace.com/support/how-to/modify-your-hosts-file/), adding the line `192.168.60.4 solr.test`, `192.168.60.5 solr.test` and `192.168.60.6 solr.test` so you can connect to the VM.
  2. Open your browser and access [http://solr.test:9090/solr/](http://solr.test:8983/solr).
...
Scripts were reworked based on the project that was created by [Jeff Geerling](https://www.jeffgeerling.com/) as an example for [Ansible for DevOps](https://www.ansiblefordevops.com/).
